...
from ai_song_downloader.src.ai import get_provider
from ai_song_downloader.src.download import download_youtube_as_mp3, get_yt_url
...
def from_prompt(prompt: str):
    ...
    songs = get_provider().get_songs_from_prompt(prompt)
